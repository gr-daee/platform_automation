...
test.describe("Manual journal entries and GL verification", () => {
  ...
  test("Manual JE should reflect in General Ledger report balances", { tag: ["@finance", "@journal-entries", "@iacs-md", "@FIN-JE-TC-008", "@p0"] }, async ({ When, page, Then }) => {
    await When("I create and post a balanced manual journal entry via UI", null, { page });
    await Then("manual JE should reflect in General Ledger report balances when posted");
  });
...
const bddFileMeta = {
  "Create balanced manual JE and verify posted status in DB": {"pickleLocation":"9:3","tags":["@finance","@journal-entries","@iacs-md","@FIN-JE-TC-001","@p0"],"ownTags":["@iacs-md","@p0","@FIN-JE-TC-001"]},
  "Create multi-line JE (4 lines) and verify all lines in DB": {"pickleLocation":"14:3","tags":["@finance","@journal-entries","@iacs-md","@FIN-JE-TC-002","@p1"],"ownTags":["@iacs-md","@p1","@FIN-JE-TC-002"]},
  "Imbalanced JE blocked — no journal posted": {"pickleLocation":"19:3","tags":["@finance","@journal-entries","@iacs-md","@FIN-JE-TC-003","@p1"],"ownTags":["@iacs-md","@p1","@FIN-JE-TC-003"]},
  "JE blocked when fiscal period is closed": {"pickleLocation":"24:3","tags":["@finance","@journal-entries","@iacs-md","@FIN-JE-TC-004","@p1"],"ownTags":["@iacs-md","@p1","@FIN-JE-TC-004"]},
  "JE date links fiscal period in DB when posted": {"pickleLocation":"29:3","tags":["@finance","@journal-entries","@iacs-md","@FIN-JE-TC-005","@p2"],"ownTags":["@iacs-md","@p2","@FIN-JE-TC-005"]},
  "JE narration text saved in description field": {"pickleLocation":"34:3","tags":["@finance","@journal-entries","@iacs-md","@FIN-JE-TC-006","@p2"],"ownTags":["@iacs-md","@p2","@FIN-JE-TC-006"]},
  "Manual JE audit source module": {"pickleLocation":"39:3","tags":["@finance","@journal-entries","@iacs-md","@FIN-JE-TC-007","@p2"],"ownTags":["@iacs-md","@p2","@FIN-JE-TC-007"]},
  "Manual JE should reflect in General Ledger report balances": {"pickleLocation":"44:3","tags":["@finance","@journal-entries","@iacs-md","@FIN-JE-TC-008","@p0"],"ownTags":["@iacs-md","@p0","@FIN-JE-TC-008"]},
};