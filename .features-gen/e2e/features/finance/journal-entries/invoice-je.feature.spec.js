...
const bddFileMeta = {
  ...
  "Invoice JE credit line uses resolved sales revenue account": {"pickleLocation":"14:3","tags":["@finance","@journal-entries","@iacs-md","@FIN-INV-TC-002","@p0"],"ownTags":["@iacs-md","@p0","@FIN-INV-TC-002"]},
  "Intra-state invoice may register CGST SGST output lines when product carries GST": {"pickleLocation":"20:3","tags":["@finance","@journal-entries","@iacs-md","@FIN-INV-TC-003","@p0"],"ownTags":["@iacs-md","@p0","@FIN-INV-TC-003"]},
  "Inter-state IGST line when warehouse creates IGST context": {"pickleLocation":"26:3","tags":["@finance","@journal-entries","@iacs-md","@FIN-INV-TC-004","@p0"],"ownTags":["@iacs-md","@p0","@FIN-INV-TC-004"]},
  "Invoice JE is balanced": {"pickleLocation":"32:3","tags":["@finance","@journal-entries","@iacs-md","@FIN-INV-TC-005","@p1"],"ownTags":["@iacs-md","@p1","@FIN-INV-TC-005"]},
  "Zero GST product posts without tax GL lines": {"pickleLocation":"38:3","tags":["@finance","@journal-entries","@iacs-md","@FIN-INV-TC-006","@p1"],"ownTags":["@iacs-md","@p1","@FIN-INV-TC-006"]},
  "Indent item tax percentage aligns with product master": {"pickleLocation":"44:3","tags":["@finance","@journal-entries","@iacs-md","@FIN-INV-TC-007","@p1"],"ownTags":["@iacs-md","@p1","@FIN-INV-TC-007"]},
  "Invoice journal number is sequential ERP format": {"pickleLocation":"50:3","tags":["@finance","@journal-entries","@iacs-md","@FIN-INV-TC-008","@p2"],"ownTags":["@iacs-md","@p2","@FIN-INV-TC-008"]},
  "Cancelled invoice creates reversing journal activity": {"pickleLocation":"56:3","tags":["@finance","@journal-entries","@iacs-md","@FIN-INVC-TC-001","@p0"],"ownTags":["@iacs-md","@p0","@FIN-INVC-TC-001"]},
  "Cancellation path maintains accounting balance": {"pickleLocation":"62:3","tags":["@finance","@journal-entries","@iacs-md","@FIN-INVC-TC-002","@p0"],"ownTags":["@iacs-md","@p0","@FIN-INVC-TC-002"]},
  "Cancelled invoice status in database": {"pickleLocation":"69:3","tags":["@finance","@journal-entries","@iacs-md","@FIN-INVC-TC-003","@p1"],"ownTags":["@iacs-md","@p1","@FIN-INVC-TC-003"]},
  "GST reversal lines may exist after cancellation": {"pickleLocation":"75:3","tags":["@finance","@journal-entries","@iacs-md","@FIN-INVC-TC-004","@p1"],"ownTags":["@iacs-md","@p1","@FIN-INVC-TC-004"]},
  "Double cancel blocked or invoice already cancelled": {"pickleLocation":"81:3","tags":["@finance","@journal-entries","@iacs-md","@FIN-INVC-TC-005","@p1"],"ownTags":["@iacs-md","@p1","@FIN-INVC-TC-005"]},
  "Invoice with applied cash receipt may block cancellation": {"pickleLocation":"88:3","tags":["@finance","@journal-entries","@iacs-md","@FIN-INVC-TC-006","@p2"],"ownTags":["@iacs-md","@p2","@FIN-INVC-TC-006"]},
  "Audit trail references invoice cancellation": {"pickleLocation":"93:3","tags":["@finance","@journal-entries","@iacs-md","@FIN-INVC-TC-007","@p2"],"ownTags":["@iacs-md","@p2","@FIN-INVC-TC-007"]},
};